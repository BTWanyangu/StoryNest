...
export default function AuthPage({ mode }) {
  ...
  useEffect(() => {
    ...
    app.setAuthMode(cleanMode);
    app.setAuthError('');
    app.setAuthNotice('');

    /**
     * Important:
     * When we are on normal auth pages, we are no longer in
     * password recovery mode. This prevents reset-password state
     * from affecting the login screen.
     */
